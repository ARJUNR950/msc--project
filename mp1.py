...
df = pd.read_csv("/home/user/Desktop/project/output data/mp14.txt",sep="\t")
...
#scatter plot
xval=plt.plot(Y1,Z1,label='posx prediction (mm)')
#labelling axis
plt.xlabel('pos(mm)')
plt.ylabel('posz(mm)')
...
plt.title(' plot obtained from points using prediction formula (14Gev)')
...
xval=plt.plot(X1,Z1,label='posx prediction (mm)')
#labelling axis
plt.xlabel('pos(mm)')
plt.ylabel('posz(mm)')
